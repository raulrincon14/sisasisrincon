<?php
  ...
  //declaramos las variables de los valores que se envian por el formulario y que recibimos por ajax y decimos que si existe el parametro que estamos recibiendo
   ...
   $estado=isset($_POST["estado"]);
    ...
    switch($_GET["op"]){
         ...
         case "guardaryeditar":
         		 ...
         		 $alumnos->registrar_alumno($idalumno,$apellido,$nombre,$dni,$fn,$nivel,$grado,$seccion,$duplicado,$estado);
         			       	   	  ...
         			       	   	  $messages[]="El Alumno se registró correctamente";
	...
	$datos=$alumnos->get_alumno_por_id($_POST["idalumno"]);
  ...
  foreach($datos as $row)
     ...
     foreach($datos as $row)
	       ...
	       $sub_array[] = $row["idalumno"];
                 ...
                 $sub_array[] = '<button type="button" onClick="cambiarEstado('.$row["idalumno"].','.$row["a_estado"].');" name="estado" id="'.$row["idalumno"].'" class="'.$atrib.'">'.$est.'</button>';
                 ...
                 $sub_array[] = '<button type="button" onClick="eliminar('.$row["idalumno"].');" id="'.$row["idalumno"].'" class="btn btn-danger btn-md"><i class="glyphicon glyphicon-edit"></i> Eliminar</button>';
