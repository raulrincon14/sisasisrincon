...
function listar()
{
	tabla=$('#alumno_data').dataTable(
	{
		...
		"ajax":
				{
					url: 'core/bin/ajax/alumno.php?op=listar',
					type : "get",
					dataType : "json",
					error: function(e){
...
function mostrar(idalumno){
	$.post("core/bin/ajax/alumno.php?op=mostrar",{idalumno : idalumno}, function(data, status)
	{
...
function guardaryeditar(e)
{
	...
	var formData = new FormData($("#alumno_form")[0]);
		...
		$.ajax({
			url: "core/bin/ajax/alumno.php?op=guardaryeditar",
		    type: "POST",
		    data: formData,
		    contentType: false,
		    processData: false,
