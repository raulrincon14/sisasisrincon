  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="jumbotron">
        ...
        <p class="lead">Es un sistema de asistencia para alumnos de la institución 1087 "Gral. Roque Saenz Peña" en su version 1.0</p>
        <center><img src="views/images/desarrollo/insignia.jpg" width="50" /></center>
        <hr class="my-4">
        <p>Con la tencología QR  </p>
        <p class="lead">
